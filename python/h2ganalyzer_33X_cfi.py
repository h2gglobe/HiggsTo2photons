...
h2ganalyzer = cms.EDAnalyzer("GlobeAnalyzer",
    ...
    JetColl_mid = cms.InputTag("sisCone5CaloJets"),
    ...
    JetColl_sis5pf = cms.InputTag("sisCone5PFJets"),
    ...
    JetTrackAssociationColl_mid = cms.InputTag("sisCone5JetTracksAssociatorAtVertex"),    
