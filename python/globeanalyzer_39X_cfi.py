...
globe = cms.EDAnalyzer(
    ...
    doJet_algoPF1 = cms.bool(True), # TODO (MATTEO) REMOVE OR SUBSTITUTE WITH PFLOW Jets
    doJet_algoPF2 = cms.bool(True), # TODO (MATTEO) REMOVE OR SUBSTITUTE WITH PFLOW Jets
    doJet_algoPF3 = cms.bool(True), # TODO (MATTEO) REMOVE OR SUBSTITUTE WITH PFLOW Jets
