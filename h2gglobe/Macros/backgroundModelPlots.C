...
void backgroundModelPlots(int mass_in=120, bool www=false, TString outdirname="BDTplots_all", int sbwidth=7, int loose=0, bool sob=0) {
  ...
  if (loose>0 && rebin) {
    ...
    hist_nominal_grad = (TH1*)(f_bdtout_nominal->Get("th1f_sig_grad_ggh_"+mass_str+".0_"+mass_str+".0_cat0"))->Clone();
    hist_nominal_ada = (TH1*)(f_bdtout_nominal->Get("th1f_sig_ada_ggh_"+mass_str+".0_"+mass_str+".0_cat0"))->Clone();
