...
ggh = f.Get("th1f_sig_%s_ggh_%3.1f_cat0"%(mode,mass)).Clone()
vbf = f.Get("th1f_sig_%s_vbf_%3.1f_cat0"%(mode,mass)).Clone()
wzh = f.Get("th1f_sig_%s_wzh_%3.1f_cat0"%(mode,mass)).Clone()
tth = f.Get("th1f_sig_%s_tth_%3.1f_cat0"%(mode,mass)).Clone()
sig = ggh.Clone()
sig.Add(vbf)
sig.Add(wzh)
sig.Add(tth)
